...
export const mockEmployerToken = makeMockToken({
  _id: "user_001", name: "Ahmed Raza", phone: "+923001234567", role: "employer", exp: 4102444800,
});

export const mockWorkerToken = makeMockToken({
  _id: "user_002", name: "Usman Ali", phone: "+923007654321", role: "worker", exp: 4102444800,
});

export const mockAdminToken = makeMockToken({
  _id: "user_admin", name: "Admin User", phone: "+923009999999", role: "admin", exp: 4102444800,
});

export const mockUser = {
  _id: "user_001", name: "Ahmed Raza", phone: "+923001234567", role: "employer", createdAt: "2024-01-15T10:00:00.000Z",
};

export const mockWorkerUser = {
  _id: "user_002", name: "Usman Ali", phone: "+923007654321", role: "worker", createdAt: "2024-01-10T10:00:00.000Z",
};

export const mockAdminUser = {
  _id: "user_admin", name: "Admin User", phone: "+923009999999", role: "admin", createdAt: "2024-01-01T10:00:00.000Z",
};
...
export const mockWorkers = [
  {
    ...
    hourlyRate: 500, dailyRate: 3500, rating: 4.7, totalRatings: 23,
    profilePicture: null, createdAt: "2024-01-10T10:00:00.000Z",
  },
  {
    _id: "worker_002",
    ...
    hourlyRate: 450, dailyRate: 3000, rating: 4.5, totalRatings: 18,
    profilePicture: null, createdAt: "2024-01-12T10:00:00.000Z",
  },
  {
    _id: "worker_003",
    ...
    hourlyRate: 400, dailyRate: 2800, rating: 4.2, totalRatings: 31,
    profilePicture: null, createdAt: "2024-01-08T10:00:00.000Z",
  },
  {
    _id: "worker_004",
    ...
    hourlyRate: 550, dailyRate: 4000, rating: 4.8, totalRatings: 15,
    profilePicture: null, createdAt: "2024-01-05T10:00:00.000Z",
  },
  {
    _id: "worker_005",
    ...
    hourlyRate: 600, dailyRate: 4500, rating: 4.6, totalRatings: 40,
    profilePicture: null, createdAt: "2024-01-03T10:00:00.000Z",
  },
];
...
export const mockJobs = [
  {
    ...
    serviceType: { _id: "st_001", name: "Electrician" },
    hireType: "hourly", hours: 4, estimatedCost: 2000, status: "pending",
  ...
  },
  {
    ...
    serviceType: { _id: "st_002", name: "Plumber" },
    hireType: "daily", days: 1, estimatedCost: 3000, status: "accepted",
  ...
  },
  {
    ...
    serviceType: { _id: "st_003", name: "Painter" },
    hireType: "daily", days: 3, estimatedCost: 8400, status: "completed",
  ...
  },
  {
    ...
    serviceType: { _id: "st_004", name: "Carpenter" },
    hireType: "hourly", hours: 6, estimatedCost: 3300, status: "cancelled",
...
export const mockWorkerJobs = [
  ...
  },
  {
    ...
    serviceType: { _id: "st_001", name: "Electrician" },
    hireType: "daily", days: 2, estimatedCost: 7000, status: "accepted",
...
export const mockNotifications = [
  { _id: "notif_001", userId: "user_001", title: "Job Request Accepted", message: "Bilal Hassan has accepted your plumbing job request.", type: "job_accepted", isRead: false, createdAt: "2025-04-10T09:00:00.000Z" },
  { _id: "notif_002", userId: "user_001", title: "Job Completed", message: "Tariq Mehmood has marked the painting job as done.", type: "job_completed", isRead: false, createdAt: "2025-03-23T14:00:00.000Z" },
  { _id: "notif_003", userId: "user_001", title: "New Message", message: "You have a new message from Usman Ali.", type: "message", isRead: true, createdAt: "2025-04-08T11:00:00.000Z" },
  { _id: "notif_004", userId: "user_001", title: "Job Request Sent", message: "Your job request has been sent to Usman Ali.", type: "job_sent", isRead: true, createdAt: "2025-04-10T08:05:00.000Z" },
];

export const mockMessages = [
  { _id: "msg_001", jobId: "job_001", senderId: "user_001", receiverId: "user_002", text: "Hello, are you available on the 15th?", createdAt: "2025-04-10T08:10:00.000Z" },
  { _id: "msg_002", jobId: "job_001", senderId: "user_002", receiverId: "user_001", text: "Yes, I am available. What time works for you?", createdAt: "2025-04-10T08:15:00.000Z" },
  { _id: "msg_003", jobId: "job_001", senderId: "user_001", receiverId: "user_002", text: "9 AM would be great. The work is in Johar Town.", createdAt: "2025-04-10T08:20:00.000Z" },
  { _id: "msg_004", jobId: "job_001", senderId: "user_002", receiverId: "user_001", text: "Perfect, I will be there at 9 AM sharp.", createdAt: "2025-04-10T08:25:00.000Z" },
];
...
export const mockDashboardMetrics = {
  totalWorkers: 48,
  totalEmployers: 132,
  activeWorkers: 12,        // ✅ realistic starting value
  totalJobs: 310,
  pendingApprovals: 3,      // ✅ matches the 3 mock pending workers below
  completedJobs: 214,
  cancelledJobs: 28,
  activeJobs: 68,
  recentWorkers: [
